...
//                
                ...
                if (result.getStatus() == Status.VALID) {
                    ...
                    KeepRecord.setUser_id(sb.findbyUserName(username));
                    System.out.println(KeepRecord.getUser_id());

                    if (result.getCallerGroups().contains("Admin")) {
                        request.getRequestDispatcher("admin/index.jsf").forward(request, response);
                    }
